...
<h1 class="page-header">文章 - 新增</h1>

<form form-ajax class="form-horizontal" id="main-form" action="/article/insert">
...
<div class="col-sm-6">
  <div class="form-group">
    ...
    <div class="col-sm-6">
      ...
      <input type="text" class="form-control required" id="inputcontent" placeholder="文章内容" name="content">
...
<div class="col-sm-6">
  <div class="form-group">
    ...
    <div class="col-sm-6">
      ...
      <input type="text" class="form-control required" id="inputtype" placeholder="文章类型" name="type">
