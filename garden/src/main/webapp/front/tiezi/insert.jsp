...
<h1 class="page-header">贴子 - 新增</h1>

<form form-ajax class="form-horizontal" id="main-form" action="/tiezi/insert" forward="/tiezi/">
...
<div class="col-sm-6">
  <div class="form-group">
    ...
    <div class="col-sm-6">
      ...
      <input type="text" class="form-control required" id="inputcreate_by" placeholder="创建人" name="create_by">
