...
<h1 class="page-header">贴子评论 - 新增</h1>

<form form-ajax class="form-horizontal" id="main-form" action="/tiezicomment/insert" forward="/tiezicomment/">
...
<div class="col-sm-6">
  <div class="form-group">
    ...
    <div class="col-sm-6">
      ...
      <input type="text" class="form-control required" id="inputcontent" placeholder="评论内容" name="content">
