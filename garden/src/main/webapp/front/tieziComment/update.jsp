...
<h1 class="page-header">贴子评论 - 修改</h1>

<form form-ajax class="form-horizontal" id="main-form" action="/tiezicomment/update" forward="/tiezicomment/">
...
<div class="col-sm-6">
  <div class="form-group">
    ...
    <div class="col-sm-6">
      ...
      <input type="text" class="form-control required" id="inputtiezi_id" placeholder="贴子编号" name="tiezi_id" value="${data.tiezi_id}">
...
<div class="col-sm-6">
  <div class="form-group">
    ...
    <div class="col-sm-6">
      ...
      <input type="text" class="form-control required" id="inputcontent" placeholder="评论内容" name="content" value="${data.content}">
...
<div class="col-sm-6">
  <div class="form-group">
    ...
    <div class="col-sm-6">
      ...
      <input type="text" class="form-control required" id="inputuser_id" placeholder="用户编号" name="user_id" value="${data.user_id}">
